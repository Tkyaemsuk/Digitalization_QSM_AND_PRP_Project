...
|---|---|---|
| Sampling.SamplingID | temperature_30.sampID | 1 Sampling มีหลาย Brik 30°C |
| Sampling.SamplingID | temperature_55.sampID | 1 Sampling มีหลาย Brik 55°C |
| [Sampling high].SamplingIDH | temperature_30high.SampID | 1 High Acid มีหลาย Brik |
| HighAcid_Sampling_Flavour.SamplingID | [Sampling high].SamplingIDH | 1 Sampling มีข้อมูล Product/Flavour |
| empolyee.Code | Sampling.SendBY และผู้ปฏิบัติงาน | พนักงานหนึ่งคนทำงานได้หลายรายการ |
| Machine.No | Sampling.Machine | เครื่องจักรหนึ่งเครื่องผลิตได้หลาย Sampling |

### ลำดับการทำงานโดยสรุป

1. 📝 สร้าง Sampling ด้วย Create Sampling.sql หรือ Create Sampling_HighAcid.sql
2. 🍓 High Acid บันทึก Product/Flavour ด้วย Create_Flavour_Sampling.sql
3. 🧱 สร้าง Brik ด้วย Temp30_Insert.sql, Temp55_Insert.sql หรือ HighAcid_InsertBrik.sql
4. 🔢 ตรวจเลข Brik ด้วย Product_Insert.sql หรือ HighAcid_Genarate_No.sql
5. 🌡️ บันทึกผลตรวจและสีด้วย Query ที่เกี่ยวข้อง
6. 📊 แสดงรายการด้วย Sampling_Table.sql หรือ Sampling_HighAcid_Tables.sql
7. 🔄 เรียกข้อมูลรายละเอียดด้วย CallBack Query
8. 🏭 ฝ่ายผลิตแก้ไขข้อมูลด้วย Sup_Production_Update.sql หรือ SupHighAcid_Production_Update.sql
9. 🔒 อัปเดตผู้ส่งและ Lock ด้วย Update Sampling.sql หรือ Update Sampling HighAcid.sql
10. ✅ สรุปจำนวน Brik ด้วย Summary.sql
